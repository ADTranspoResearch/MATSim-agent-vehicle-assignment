...
def main():
    ...
    historic_pop = historic_pop.merge(fleet_size, how="left", left_index=True, right_on="year")
    ...
    historic_pop["fleet_growth"] = historic_pop["fleet_size"] - historic_pop["fleet_size"].shift(1)
